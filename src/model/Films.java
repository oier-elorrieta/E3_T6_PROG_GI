...
public class Films {
	...
	public Films(String film_name, double film_duration, double film_price, String film_genre) {
	...
	public Films(String film_name, String film_duration, String film_price, String film_genre) {
		this.film_name = film_name;
	...
	public String toString() {
		return "Films [film_name=" + film_name + ", film_duration=" + film_duration
